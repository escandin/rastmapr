calibrationParameters2Updated <- structure(function #Calibration parameters
### This function ...
...
(
  ...
  refmsk=stackmaskUpdated(ref)[[2]]
  tarmsk=stackmaskUpdated(tar)[[2]]
  ...
  if (terra::nlyr(tarmskd) == terra::nlyr(refmskd)) {
    nb = (terra::nlyr(tarmskd))
  } else {
  ...
  inrefmat=lapply(terra::as.list(refmskd), function(x)
    extractvalid(x))
  intarmat=lapply(terra::as.list(tarmskd), function(x)
    extractvalid(x))
